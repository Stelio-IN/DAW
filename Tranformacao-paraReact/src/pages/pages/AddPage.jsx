...
const AddPage = () => {
  ...
  const pageLayoutOptions = [
    ...
    { label: "Blog com barra lateral", value: "blogSidebar" },
    { label: "Largura total", value: "fullWidth" },
      ...
      <div className="container">
        <div className="wrapper">
          <div className="content">
            ...
            <div className="content_item meta_data">
              ...
              <div className="column">
                <Input
                  type="text"
                  placeholder="Insira o título meta"
                  label="Título"
              ...
              <div className="column">
                <Input
                  type="text"
                  placeholder="Insira o link meta"
                  label="Link"
              ...
              <div className="column">
                <Textarea
                  type="text"
                  placeholder="Insira a descrição meta"
                  label="Descrição"
          ...
          <div className="sidebar">
            ...
            <div className="sidebar_item">
              <h2 className="sub_heading">Estado</h2>
              <div className="column">
                <Dropdown
            ...
            <div className="sidebar_item">
              ...
              <div className="column">
                <Dropdown
                  ...
                  placeholder="Selecione o layout da página"
                />
              </div>
            </div>
