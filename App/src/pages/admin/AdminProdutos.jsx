        ...
        <div className="product-list">
          {produtosFiltrados.map((prod) => (
            ...
            >
              <img
                src={
                  prod.primary_image_url || "https://via.placeholder.com/150"
                }
      ...
      <div className="product-details-section">
        ...
        {produtoSelecionado && (
          <>
            <img
              src={
                produtoSelecionado.primary_image_url ||
            ...
            <div>
              ...
              <input
                type="text"
                value={produtoSelecionado.product_name}
                readOnly
              />
            </div>
            ...
            <div className="cores">
              ...
              <button
                onClick={() => goToDetails(produtoSelecionado.product_id)} id="btn_detail"
              >
